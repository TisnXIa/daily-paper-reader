...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-19 19:15:47 UTC<br>状态：成功</p>
</section>
...
<p>今日精读1篇、速读1篇，共完成2篇论文阅读；其中组合回归方向的高分文章值得重点留意。</p>
<p>最值得看的是《Graph-Adaptive Horseshoe for Compositional Regression》（9.0分），聚焦组合回归中图自适应马蹄先验的应用。</p>
<p>下一步建议优先精读这篇高分论文，并顺带浏览朴素贝叶斯拓展文章的校准思路。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Graph-Adaptive Horseshoe for Compositional Regression">Graph-Adaptive Horseshoe for Compositional Regression</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Hierarchical Empirical-Bayes Naive Bayes: Minimax Smoothing and Calibration with AODE Extension">Hierarchical Empirical-Bayes Naive Bayes: Minimax Smoothing and Calibration with AODE Extension</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">microbiome <strong>1</strong></span></div>
</section>
</div>
